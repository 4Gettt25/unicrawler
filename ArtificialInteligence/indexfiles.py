...
client = Elasticsearch(
  ...
  api_key="djEzalBKQUJxaUw5aGNZclRqdkk6UFYxbVpUaF9Rb2FVLWZxaFlQbmlUUQ==",
  verify_certs=False
)

documents = [
  { "index": { "_index": "qualitätsmanagement", "_id": "9780553351927"}},
  ...
  { "index": { "_index": "qualitätsmanagement", "_id": "9780441017225"}},
  ...
  { "index": { "_index": "qualitätsmanagement", "_id": "9780451524935"}},
  ...
  { "index": { "_index": "qualitätsmanagement", "_id": "9781451673319"}},
  ...
  { "index": { "_index": "qualitätsmanagement", "_id": "9780060850524"}},
  ...
  { "index": { "_index": "qualitätsmanagement", "_id": "9780385490818"}},
...
client.search(index="qualitätsmanagement", q="snow")